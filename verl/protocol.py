...
def union_tensor_dict(tensor_dict1: TensorDict, tensor_dict2: TensorDict) -> TensorDict:
    ...
    was_locked = getattr(tensor_dict1, "is_locked", False)
    if was_locked and hasattr(tensor_dict1, "unlock_"):
    ...
    try:
        for key in tensor_dict2.keys():
            ...
            if hasattr(tensor_dict1, "set_") and key in tensor_dict1:
                tensor_dict1.set_(key, tensor_dict2[key])
            else:
                tensor_dict1[key] = tensor_dict2[key]
    finally:
        if was_locked and hasattr(tensor_dict1, "lock_"):
            tensor_dict1.lock_()
